...
ByteAddressBuffer Form_Factor_Normal_Distribution : register(t0);

TextureCube LD_Normal_Distribution : register(t1);

#define Hemispherical_Directional_Reflectance_LUT_INDEX_TR 0

Texture2DArray Hemispherical_Directional_Reflectance_LUT : register(t2);

SamplerState clamp_linear_sampler : register(s0);
