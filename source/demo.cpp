...
#include "../thirdparty/Environment-Lighting/include/brx_sh_project_environment_map_reduction.h"
...
#include "../shaders/dxbc/debug/sh_project_environment_map_clear.inl"
#include "../shaders/dxbc/debug/sh_project_equirectangular_map_reduction.inl"
#include "../shaders/dxbc/debug/sh_project_octahedral_map_reduction.inl"
...
#include "../shaders/dxbc/release/sh_project_environment_map_clear.inl"
#include "../shaders/dxbc/release/sh_project_equirectangular_map_reduction.inl"
#include "../shaders/dxbc/release/sh_project_octahedral_map_reduction.inl"
...
void Demo::Init(ID3D11Device *d3d_device, ID3D11DeviceContext *d3d_device_context, IDXGISwapChain *dxgi_swap_chain)
{
	...
	{
		HRESULT res_d3d_device_create_compute_shader = d3d_device->CreateComputeShader(code_shader_sh_project_environment_map_clear, sizeof(code_shader_sh_project_environment_map_clear), NULL, &this->m_sh_project_environment_map_clear_cs);
		assert(SUCCEEDED(res_d3d_device_create_compute_shader));
	}

	this->m_sh_project_equirectangular_map_reduction_cs = NULL;
	{
		HRESULT res_d3d_device_create_compute_shader = d3d_device->CreateComputeShader(code_shader_sh_project_equirectangular_map_reduction, sizeof(code_shader_sh_project_equirectangular_map_reduction), NULL, &this->m_sh_project_equirectangular_map_reduction_cs);
		assert(SUCCEEDED(res_d3d_device_create_compute_shader));
	}

	this->m_sh_project_octahedral_map_reduction_cs = NULL;
	{
		HRESULT res_d3d_device_create_compute_shader = d3d_device->CreateComputeShader(code_shader_sh_project_octahedral_map_reduction, sizeof(code_shader_sh_project_octahedral_map_reduction), NULL, &this->m_sh_project_octahedral_map_reduction_cs);
		assert(SUCCEEDED(res_d3d_device_create_compute_shader));
	}
...
void Demo::Tick(ID3D11Device *d3d_device, ID3D11DeviceContext *d3d_device_context, IDXGISwapChain *dxgi_swap_chain)
{
	...
	// sh project equirectangular map
	{
		...
		UINT const tile_num_width = static_cast<UINT>(static_cast<float>(this->m_environment_equirectangular_map_width + BRX_SH_PROJECT_ENVIRONMENT_MAP_REDUCTION_THREAD_GROUP_X - 1) / static_cast<float>(BRX_SH_PROJECT_ENVIRONMENT_MAP_REDUCTION_THREAD_GROUP_X));
		UINT const tile_num_height = static_cast<UINT>(static_cast<float>(this->m_environment_equirectangular_map_height + BRX_SH_PROJECT_ENVIRONMENT_MAP_REDUCTION_THREAD_GROUP_Y - 1) / static_cast<float>(BRX_SH_PROJECT_ENVIRONMENT_MAP_REDUCTION_THREAD_GROUP_Y));
	...
	// sh project octahedral map
	{
		...
		UINT const tile_num_width = static_cast<UINT>(static_cast<float>(this->m_environment_octahedral_map_width + BRX_SH_PROJECT_ENVIRONMENT_MAP_REDUCTION_THREAD_GROUP_X - 1) / static_cast<float>(BRX_SH_PROJECT_ENVIRONMENT_MAP_REDUCTION_THREAD_GROUP_X));
		UINT const tile_num_height = static_cast<UINT>(static_cast<float>(this->m_environment_octahedral_map_height + BRX_SH_PROJECT_ENVIRONMENT_MAP_REDUCTION_THREAD_GROUP_Y - 1) / static_cast<float>(BRX_SH_PROJECT_ENVIRONMENT_MAP_REDUCTION_THREAD_GROUP_Y));
