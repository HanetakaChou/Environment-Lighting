...
//-------------------------------------------------------------------------------------
_Use_decl_annotations_ float *XM_CALLCONV DirectX::XMSHEvalDirection(
    float *result,
    size_t order,
    FXMVECTOR dir)
{
...
//-------------------------------------------------------------------------------------
_Use_decl_annotations_ float *XM_CALLCONV DirectX::XMSHRotate(
    float *result,
    size_t order,
    FXMMATRIX rotMatrix,
    const float *input)
...
//-------------------------------------------------------------------------------------
_Use_decl_annotations_ float *DirectX::XMSHRotateZ(
    float *result,
    size_t order,
    float angle,
    const float *input)
...
//-------------------------------------------------------------------------------------
_Use_decl_annotations_ float *DirectX::XMSHAdd(
    float *result,
    size_t order,
    const float *inputA,
    const float *inputB)
...
//-------------------------------------------------------------------------------------
_Use_decl_annotations_ float *DirectX::XMSHScale(
    float *result,
    size_t order,
    const float *input,
    float scale)
...
//-------------------------------------------------------------------------------------
_Use_decl_annotations_ float DirectX::XMSHDot(
    size_t order,
    const float *inputA,
    const float *inputB)
{
...
// (f*(g*h) != (f*g)*h.
//-------------------------------------------------------------------------------------
_Use_decl_annotations_ float *DirectX::XMSHMultiply(
    float *result,
    size_t order,
    const float *inputF,
    const float *inputG)
...
//-------------------------------------------------------------------------------------
_Use_decl_annotations_ float *DirectX::XMSHMultiply2(
    float *y,
    const float *f,
    const float *g)
{
...
//-------------------------------------------------------------------------------------
_Use_decl_annotations_ float *DirectX::XMSHMultiply3(
    float *y,
    const float *f,
    const float *g)
{
...
//-------------------------------------------------------------------------------------
_Use_decl_annotations_ float *DirectX::XMSHMultiply4(
    float *y,
    const float *f,
    const float *g)
{
...
//-------------------------------------------------------------------------------------
_Use_decl_annotations_ float *DirectX::XMSHMultiply5(
    float *y,
    const float *f,
    const float *g)
{
...
//-------------------------------------------------------------------------------------
_Use_decl_annotations_ float *DirectX::XMSHMultiply6(
    float *y,
    const float *f,
    const float *g)
{
...
//-------------------------------------------------------------------------------------
_Use_decl_annotations_ bool XM_CALLCONV DirectX::XMSHEvalDirectionalLight(
    size_t order,
    FXMVECTOR dir,
    FXMVECTOR color,
    float *resultR,
...
//-------------------------------------------------------------------------------------
_Use_decl_annotations_ bool XM_CALLCONV DirectX::XMSHEvalSphericalLight(
    size_t order,
    FXMVECTOR pos,
    float radius,
    FXMVECTOR color,
...
//-------------------------------------------------------------------------------------
_Use_decl_annotations_ bool XM_CALLCONV DirectX::XMSHEvalConeLight(
    size_t order,
    FXMVECTOR dir,
    float radius,
    FXMVECTOR color,
...
//-------------------------------------------------------------------------------------
_Use_decl_annotations_ bool XM_CALLCONV DirectX::XMSHEvalHemisphereLight(
    size_t order,
    FXMVECTOR dir,
    FXMVECTOR topColor,
