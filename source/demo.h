...
class Demo
{
	...
	ID3D11Texture2D *m_environment_cube_map;
	ID3D11ShaderResourceView *m_environment_cube_map_srv;
	UINT32 m_environment_cube_map_width;
	UINT32 m_environment_cube_map_height;

	ID3D11ComputeShader *m_cube_map_to_octahedral_map_cs;
	...
	ID3D11ComputeShader* m_cube_map_to_equirectangular_map_cs;
	...
	ID3D11UnorderedAccessView* m_environment_equirectangular_map_uav;
